...
namespace Gui {
class GainMeterSpirograph;
class TopComponent : public juce::Component {
public:
  TopComponent(juce::AudioProcessorValueTreeState& parameters, Service::PresetManger presetManger, GainMeterSpirograph &gm) :
  headerComponent(parameters, std::move(presetManger)),
  visualComponent(parameters, gm)
  {
